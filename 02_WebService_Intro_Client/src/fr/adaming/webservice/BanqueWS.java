 ...
 * 
 */
@WebServiceClient(name = "banqueWS", targetNamespace = "http://webservice.adaming.fr/", wsdlLocation = "http://localhost:8888/banqueWS?WSDL")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://webservice.adaming.fr/", "banqueWS");
    ...
    public BanqueWebService getBanqueWebServicePort() {
        return super.getPort(new QName("http://webservice.adaming.fr/", "BanqueWebServicePort"), BanqueWebService.class);
    }
    ...
    public BanqueWebService getBanqueWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.adaming.fr/", "BanqueWebServicePort"), BanqueWebService.class, features);
    }
